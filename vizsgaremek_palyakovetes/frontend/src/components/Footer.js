...
function Copyright() {
  return (
    <Typography variant="body2" color="text.secondary">
      {'Copyright © '}
      <Link color="inherit" href=""> {/*href link csere később */}
        Your Website
      </Link>{' '}
 ...
 function Footer(props) {
  ...
  const privacyPolicy = <Link href="">Adatvédelmi tájékoztató</Link> /*href link csere később */
  const supportedBrowsers = <Link href="">Támogatott böngészők</Link> /*href link csere később */
